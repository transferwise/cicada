...
DROP TRIGGER IF EXISTS tr_global_settings ON public.global_settings;
...
DROP TRIGGER IF EXISTS tr_schedule_groups ON public.schedule_groups;
...
(
  ...
  exec_command character varying(255) NOT NULL,
...
CREATE TABLE IF NOT EXISTS public.schedule_log_status
(
  schedule_log_status_id integer NOT NULL,
  constant character varying(30) NOT NULL,
  name character varying(64) NOT NULL,
